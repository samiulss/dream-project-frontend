...
function ContentUpload() {
  const {
    loggedInUser, auth, catagory, setCatagory
  } = ContentState();
  ...
  const [closeCatagory, setCloseCatagory] = useState(false);
  ...
  const handleFiles = async (files) => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      setSelectedFile((prev) => [
        ...prev,
        { name: file.name, loading: 0, size: file.size },
      ]);
    }
  ...
  return (
    <>
      ...
      <div
        ...
        className="upload-content-btn rounded-5"
      >
        <span className="svg-icon upload-logo" />
        <span className="fw-semibold click-to-upload-text">
          Click to Upload
        </span>
      </div>
          ...
          >
              ...
              <div className="row">
                ...
                <div className="col-lg-6 left-side d-flex flex-column">
                  <div className="thumbnail">
                    {!showThumbnail ? (
                      <label
                        ...
                        type="button"
                        className="thumbnail-label rounded-3 border custom-border-color custom-bg-color d-flex flex-column justify-content-center align-items-center fs-5"
                      >
                        Thumbnail
                  ...
                  <div className="title">
                    <input
                      type="text"
                      className="w-100 custom-bg-color custom-border-color rounded-2"
                  ...
                  <div className="catagory-list">
                    <Filter
                      contentUpload
                      closeCatagory={closeCatagory}
                      setCloseCatagory={setCloseCatagory}
                    />
                  </div>
                  ...
                  <div className="upload-main-file d-flex flex-column">
                    <div className="upload-container rounded-2 mb-3">
                      <label
                        ...
                        className={
                          dragActive
                            ? 'rounded-3 text-center w-100 bg-white'
                            : 'rounded-3 text-center w-100'
                        }
                    ...
                    <div className="uploaded-file-list d-flex flex-column-reverse">
                      <div>
                        ...
                        {uploadedFiles.map((uploadFile, index) => (
                          ...
                          >
                            <li
                              className="mb-0 text-dark upload-file-name"
            ...
            <div className="border-0 text-center">
              <button
                style={{ height: '45px' }}
                type="submit"
                className="btn w-50 base-bg-color-1 text-white rounded-5 border-0 p-0"
              >
